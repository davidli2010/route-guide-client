...
fn main() {
    ...
    client.get_feature(Point::new(409146138, -746188906));
    // Feature missing.
    client.get_feature(Point::new(0, 0));

    println!();
    println!("List features:");
    client.list_features(Rectangle {
        lo: Some(Point::new(400000000, -750000000)),
        hi: Some(Point::new(420000000, -730000000)),
    });
